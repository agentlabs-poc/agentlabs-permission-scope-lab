...
M2 evaluator is in progress; next is the localadapter/in-process command before
M3 HTTP wrapping. See implementation/plan/auth-middleware-execution.md for actual
