...
| HC-09-06 | OPEN | Define freshness, caching, revocation propagation, and stale membership/dependency behavior. | Q-069 proposes no stale-cache grace period for new checks after confirmed grant revocation in [authority freshness](authority-freshness.md). Not yet agreed; cache mechanism and membership/dependency propagation remain open. |
