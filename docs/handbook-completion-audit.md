...
| HC-05-11 | OPEN | Complete ordinary grant status/validity and create/change/revoke lifecycle rules. | Q-078 proposes terminal explicit revocation in [grant lifecycle](grant-lifecycle.md), not yet approved. Full status/validity, administrative operation, and lifecycle representation remain open. |
