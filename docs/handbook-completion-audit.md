...
| HC-09-07 | OPEN | Define concurrent-change/check-to-use consistency guarantees. | Q-074 proposes preserving evaluated application boundaries through use in [concurrent enforcement](concurrent-enforcement.md), not yet approved. Mechanisms, conflict/retry behavior, and in-flight Auth authority changes remain open. |
