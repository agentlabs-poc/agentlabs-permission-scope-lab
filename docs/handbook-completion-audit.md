...
| HC-08-02 | OPEN | Finalize decision outcomes, reasons, and missing/unknown/failure behavior. | Q-051–Q-064 settle core meanings and three minimal result shapes in [decision results](decision-results.md). Full validation, code catalogue/compatibility, and missing/unknown cases remain unfinished; Q-065 mixed-variant validation is proposed. No fractional completion credit. |
