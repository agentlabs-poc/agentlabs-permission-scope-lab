...
| HC-09-05 | OPEN | Define bulk authorization, partial success, and operation transaction semantics. | Q-073 proposes complete-batch authorization and boundary checks before effects in [bulk enforcement](bulk-enforcement.md), not yet approved. Transaction, concurrency, retry, and representation contracts remain open. |
