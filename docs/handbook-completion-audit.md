...
| HC-09-03 | OPEN | Define collection, count, export, and row/field restriction contracts. | Q-071 agrees denial instead of automatic authorized-subset filtering. Q-072 proposes explicit request-boundary semantics in [collection enforcement](collection-enforcement.md). Counts, pagination, exports, and row/field enforcement contracts remain unfinished. |
