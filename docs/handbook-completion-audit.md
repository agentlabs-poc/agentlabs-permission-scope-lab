...
| HC-09-03 | OPEN | Define collection, count, export, and row/field restriction contracts. | Q-071 proposes authorized-subset behavior in [collection enforcement](collection-enforcement.md), not yet agreed. Counts, pagination, exports, and row/field enforcement contracts remain unfinished. |
