...
| GROUP-005 | PROPOSED | In v1, resolve group grants through direct human-to-group memberships only; no nested-group inheritance. | Q-077 returns to the canonical membership model. Direct membership avoids recursive traversal, cycles, and transitive dependency rules, at the cost of maintaining multiple explicit memberships. Human-only membership stays agreed; this separately decides nesting. See groups-and-membership.md. |
...
decision, not pending work. Return to **Q-077 / GROUP-005, proposed**: direct
human-to-group memberships without nested-group inheritance in v1.
