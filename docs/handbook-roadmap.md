...
| GRANT-004 | PROPOSED | Explicit revocation is terminal for that grant; restoring access requires a newly authorized grant rather than reactivation of the old grant identity. | Q-078 contrasts revoked G-17 with a newly authorized G-18. Stable revocation semantics avoid an additional reactivation transition, at the cost of creating a new grant for restoration. Q-070's automatic recovery of still-valid dependent delegation remains unchanged. No status schema, retention policy, or dependency rebinding adopted. See grant-lifecycle.md. |
...
**Q-078 / GRANT-004, proposed:** explicit revocation is terminal for that grant,
with restoration through a newly authorized grant. Membership/sync mechanics
and lifecycle representation remain open.
