# Current handbook state — RECON-002, through Q-133
...
## Thirteen decisions recorded since the previous checkpoint
...
These are thirteen answered decisions, not thirteen completed chapters or thirteen
