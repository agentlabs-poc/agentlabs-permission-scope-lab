# Current handbook state — RECON-002, through Q-151
...
## Thirty decisions recorded since the previous checkpoint
...
These are thirty answered decisions, not thirty completed chapters or thirty
...
status and had no rule at all for removal. The answer replaced both special cases
with one dependency rule covering every grant.
...
| Full criteria | **46 DONE / 22 OPEN / 1 EXCLUDED** | 68 in scope: 67.6% closed, 32.4% open. HC-08-04 closed by CLOSURE-002; earlier figures retained as history. |
